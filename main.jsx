...
jobs:
  android:
    ...
    steps:
      ...
      # ✅ BULLETPROOF FIX — Python handles ANY manifest format
      - name: Fix AndroidManifest namespace — FINAL FIX
        ...
        run: |
          ...
          if 'xmlns:android="http://schemas.android.com/apk/res/android"' in content:
              ...
              content = re.sub(
                  r"<manifest(\s*[^>]*)>",
                  r'<manifest xmlns:android="http://schemas.android.com/apk/res/android"\1>',
                  content,
                  count=1
              )
      ...
      - name: Upload Android debug APK
        uses: actions/upload-artifact@v4
        with:
          name: love-that-android-debug-apk
